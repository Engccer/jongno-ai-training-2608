...
종로구시각장애인취업역량강화센터 「재직자 AI 활용 직무향상과정(교사)」 김헌용 담당 4회기(2026-08-26~09-05)의 훈련생 배포용 강의 웹페이지. 페이지 제목(`<title>`·h1)은 강사가 4회기를 묶어 붙인 시리즈 제목 「AI 에이전트 실습 - Claude로 학교업무 자동화하기」이고, 기관 과정명은 그 아래 줄에 둔다. 훈련생 4명 전원이 전맹 센스리더 사용자이므로 슬라이드덱이 아니라 **원고 열람 페이지**다.
